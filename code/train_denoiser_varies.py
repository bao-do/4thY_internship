...
from model.cnn import FFTResNet_varied_noise
# %load_ext autoload
# %autoreload 2
...
def train(sigma_max, sigma_min, n_epochs,batch_size, lr):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    c_out_list = [8,16,64,64,16,8]
    fftRN_model= FFTResNet_varied_noise(input_size=(28,28),c_out_list=c_out_list)
    ...
    for epoch in pb_bar:
        ...
        with torch.no_grad():
            if epoch%100==0:
                ...
                torch.save(fftRN_model.state_dict(), 'fft_conv2d_varied_sigma_whole_dataset.pt')




# python train_denoiser.py --n_epochs 100 --batch_size 32 --sigma_max 5  --sigma_min 0.1 --lr 0.005 
if __name__ == '__main__':
    ...
    train(sigma_max,sigma_min,n_epochs,batch_size,lr)
